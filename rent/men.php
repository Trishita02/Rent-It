...
$base_sql = "SELECT * FROM `product` WHERE category='Men' AND status=1";
if ($search_query) {
...
<section id="header">
    <div class="header-container">
        ...
        <form action="men.php" method="get" class="search-box">
...
<section id="hero1" class="men-hero">
    <div>
        <h4>Mens Wear On Rent</h4>
...
function sortProducts(option) {
    ...
    var newUrl = 'men.php?sort=' + option + '&search=' + searchQuery;
